...
const Home = () => {
  return (
    ...
    >
      ...
      {/* HOW IT WORKS */}
      <section className="bg-[#0A0A0A]/75 backdrop-blur-md py-20 px-6 relative overflow-hidden border-t border-white/10 text-white">
      ...
      {/* TRENDING PROBLEMS */}
      <section className="bg-[#0A0A0A]/60 backdrop-blur-md py-20 px-6 border-t border-white/10">
        <div className="container mx-auto max-w-7xl">
          <div className="flex justify-between items-end mb-10">
            <SectionHeading 
              ...
              dark
            />
            <Link to="/problems" className="hidden md:flex items-center gap-1 font-semibold text-[#E5B268] hover:underline transition-colors pb-4">
          ...
          <Link to="/problems" className="mt-8 flex md:hidden items-center justify-center gap-2 font-semibold text-[#E5B268]">
      ...
      {/* FEATURED PRODUCTS */}
      <section className="bg-[#0A0A0A]/70 backdrop-blur-md py-20 px-6 border-t border-white/10">
        <div className="container mx-auto max-w-7xl">
          <div className="flex justify-between items-end mb-10">
            <SectionHeading 
              label="FEATURED" 
              ...
              dark
            />
            <Link to="/products" className="hidden md:flex items-center gap-1 font-semibold text-[#E5B268] hover:underline transition-colors pb-4">
              View All <ArrowRight size={16} />
            </Link>
          </div>
      ...
      {/* SMART BUNDLES */}
      <section className="bg-[#0A0A0A]/80 backdrop-blur-md py-20 px-6 border-t border-white/10">
        <div className="container mx-auto max-w-7xl">
          <SectionHeading 
            label="SMART BUNDLES" 
      ...
      {/* STATS SECTION */}
      <section className="bg-[#0A0A0A]/60 backdrop-blur-md py-16 px-6 border-t border-b border-white/10">
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-white/10">
            <div className="text-center px-4">
              <div className="text-[40px] md:text-[56px] font-extrabold text-white"><AnimatedNumber value={10} />k+</div>
              <div className="text-[14px] text-white/70 mt-2">Problems Solved</div>
            </div>
            <div className="text-center px-4">
              <div className="text-[40px] md:text-[56px] font-extrabold text-white"><AnimatedNumber value={98} />%</div>
              <div className="text-[14px] text-white/70 mt-2">Success Rate</div>
            </div>
            <div className="text-center px-4">
              <div className="text-[40px] md:text-[56px] font-extrabold text-white"><AnimatedNumber value={500} />+</div>
              <div className="text-[14px] text-white/70 mt-2">Curated Products</div>
            </div>
            <div className="text-center px-4">
              <div className="text-[40px] md:text-[56px] font-extrabold text-white"><AnimatedNumber value={24} />/<AnimatedNumber value={7} /></div>
              <div className="text-[14px] text-white/70 mt-2">AI Support</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* TESTIMONIALS */}
      <section className="bg-[#0A0A0A]/70 backdrop-blur-md py-20 px-6 border-b border-white/10">
        <div className="container mx-auto max-w-7xl">
          <SectionHeading 
            label="TESTIMONIALS" 
      ...
      {/* FINAL CTA BANNER */}
      <section className="bg-[#0A0A0A]/85 backdrop-blur-md py-24 px-6 relative overflow-hidden">
